...
//		this.apiKey = key;
	...
	public boolean shouldUpdate(String localVersion, String remoteVersion) {
		// Modified for FastCraft. Newer versions have higher integer versions
		String[] localSplit = localVersion.split(DELIMETER);
		String[] remoteSplit = remoteVersion.split(DELIMETER);
		int local, remote;
		try {
			local = Integer.parseInt(localSplit[localSplit.length - 1]);
			remote = Integer.parseInt(remoteSplit[remoteSplit.length - 1]);
