...
import net.minecraft.server.v1_6_R2.RecipeArmorDye;
import net.minecraft.server.v1_6_R2.RecipeFireworks;
import net.minecraft.server.v1_6_R2.RecipeMapClone;
import net.minecraft.server.v1_6_R2.RecipeMapExtend;
import net.minecraft.server.v1_6_R2.ShapedRecipes;
import net.minecraft.server.v1_6_R2.ShapelessRecipes;

public class RecipeUtil_v1_6_R2 extends RecipeUtil {

	public RecipeUtil_v1_6_R2() {
