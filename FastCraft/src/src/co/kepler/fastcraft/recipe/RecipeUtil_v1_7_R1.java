...
import net.minecraft.server.v1_7_R1.RecipeArmorDye;
import net.minecraft.server.v1_7_R1.RecipeBookClone;
import net.minecraft.server.v1_7_R1.RecipeFireworks;
import net.minecraft.server.v1_7_R1.RecipeMapClone;
import net.minecraft.server.v1_7_R1.RecipeMapExtend;
import net.minecraft.server.v1_7_R1.ShapedRecipes;
import net.minecraft.server.v1_7_R1.ShapelessRecipes;

public class RecipeUtil_v1_7_R1 extends RecipeUtil {

	public RecipeUtil_v1_7_R1() {
